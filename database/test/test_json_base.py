...
class TestJSONBase:
    def setup_method(self) -> None:
        self.load_database = JSONBase(r'E:\PyCharmProjects\MyMoney\database\test\test_data.json')
        self.save_database = JSONBase(r'E:\PyCharmProjects\MyMoney\database\test\new_test_data.json')
    ...
    def test_database_save_data(self) -> None:
        ...
        accounts = json.load(Path(r'E:\PyCharmProjects\MyMoney\database\test\new_test_data.json').open())
